...
public class UpdateDeleteMobile extends AppCompatActivity {
...
//TextView key1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("mobile").child(key);
    ...
    public void btnDel(View view) {
        ref.removeValue().addOnCompleteListener(task -> {
            ...
            {
                Toast.makeText(UpdateDeleteMobile.this, "Удалено!",Toast.LENGTH_SHORT).show();
                Intent i = new Intent(UpdateDeleteMobile.this, MobilePhoneShow.class);
                startActivity(i);
            }
    ...
    public void btnSave(View view) {
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(UpdateDeleteMobile.this, "Успешно изменено!!"
