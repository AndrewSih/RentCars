...
public class PlayStationShowChange extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseListOptions<RentObject> options = new FirebaseListOptions.Builder<RentObject>()
                ...
                .setLifecycleOwner(PlayStationShowChange.this)
        ...
        lv.setOnItemClickListener((parent, view, position, id) -> {
            Intent updateDelete = new Intent(PlayStationShowChange. this, UpdateDeletePs.class);
    ...
    public void btnAddCar(View view) {
        Intent register = new Intent(PlayStationShowChange.this,AddPlayStation.class );
        startActivity(register);
    }
    public void btnExit(View view) {
        Intent register = new Intent(PlayStationShowChange.this,CategoryScreen.class );
        startActivity(register);
    }
}
