...
public class UpdateDeletePs extends AppCompatActivity {
...
//TextView key1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("PS").child(key);
    ...
    public void btnDel(View view) {
        ref.removeValue().addOnCompleteListener(task -> {
            ...
            {
                Toast.makeText(UpdateDeletePs.this, "Удалено!",Toast.LENGTH_SHORT).show();
                Intent i = new Intent(UpdateDeletePs.this, PlayStationShowChange.class);
                startActivity(i);
            }
    ...
    public void btnSave(View view) {
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(UpdateDeletePs.this, "Успешно изменено!!"
